...
-- used for IT2351 by Erik Nilsson, Fall 2020
-- *****************************************************
...
-- create database
DROP DATABASE IF EXISTS ErikNilssonOrderManagement;
CREATE DATABASE ErikNilssonOrderManagement;

-- select database
USE ErikNilssonOrderManagement;
